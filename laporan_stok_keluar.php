...
// Query untuk mendapatkan laporan stok keluar (penjualan)
$query = "SELECT 
            p.tanggal, 
            b.nama_barang, 
            SUM(dp.qty) as jumlah_keluar, 
            dp.harga, 
          ...
          GROUP BY dp.id_barang, DATE(p.tanggal)
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseLaporanStok" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="laporan_stok_keluar.php">
                ...
                <main>
                    <div class="container-fluid px-4">   
                        <div class="container mt-4">
                            <h1 class="text-center mb-4">Laporan Stok Keluar</h1>
                                    ...
                                    <form method="GET" action="">
                                        ...
                                        <div class="card mb-4 mt-3">
                                            <div class="card-header text-center">
                                                <h5 class="mb-0">Ringkasan Stok Keluar Bulan <?= $nama_bulan[$bulan] ?> <?= $tahun ?></h5>
                                            </div>
                                            <div class="card-body">
                            ...
                            <!-- Tabel Detail Stok Keluar -->
                            <div class="card mb-4">
                                <div class="card-header bg-dark text-white">
                                    <h5 class="mb-0">Detail Stok Keluar Bulan <?= $nama_bulan[$bulan] ?> <?= $tahun ?></h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="6" class="text-center">Tidak ada stok keluar pada bulan ini</td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
