...
echo "<!-- Debug: Tanggal: $tanggal -->";

// Query untuk mendapatkan penjualan berdasarkan tanggal
$query = "SELECT p.tanggal, b.nama_barang, dp.qty, dp.harga, dp.subtotal 
...
$total_query = "SELECT SUM(total) as total_harian FROM penjualan WHERE DATE(tanggal) = '$tanggal'";
$total_result = mysqli_query($conn, $total_query);

if (!$total_result) {
    $error = mysqli_error($conn);
    echo "<!-- Debug: Total Query Error: " . htmlspecialchars($error) . " -->";
}

$total_data = mysqli_fetch_assoc($total_result);
$total_harian = $total_data['total_harian'] ?? 0;
echo "<!-- Debug: Total Harian: $total_harian -->";
?>  
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="laporan_harian.php">
                         ...
                         <div class="container mt-4">
                            ...
                            <div class="card mb-4 ">
                                <div class="card-header bg-primary text-white no-print">
                                    <h5 class="mb-0">Pilih Tanggal Laporan</h5>
                                </div>
                                <div class="card-body">
                                    <form method="GET" action="">
                                        <div class="row no-print">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $tanggal ?>" max="<?= date('Y-m-d') ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-4 mt-3">
                                            <div class="card-header">
                                                <h5 class="mb-0 text-center">Total Penjualan Tanggal <?= date('d F Y', strtotime($tanggal)) ?></h5>
                                            </div>
                                            <div class="card-body bg-info">
                                                <h3 class="text-center">Rp <?= number_format($total_harian, 0, ',', '.') ?></h3>
                                            </div>
                                        </div>
                                     </div>
                                 </div>
                                         <div class="card mt-3">
                                            <div class="card-header bg-dark text-white">
                                                <h5 class="mb-0">Detail Barang Terjual - <?= date('d F Y', strtotime($tanggal)) ?></h5>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if ($result && mysqli_num_rows($result) > 0) {
                                                                ...
                                                                ?>
                                                                <tr>
                                                                    <td colspan="6" class="text-center">Tidak ada penjualan pada tanggal <?= date('d/m/Y', strtotime($tanggal)) ?></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                            ?>
